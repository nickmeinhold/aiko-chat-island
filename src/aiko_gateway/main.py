...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        try:
            ...
            # failed", which reads as the provider's fault forever. The ordering IS
            # the fix: the drain stays first and every transport close comes after
...
from .rest import read_positions as read_position_routes  # noqa: E402
...
app.include_router(read_position_routes.router)
