...
class Settings(BaseSettings):
    ...
    island_id: str = ""
    # Human label the picker shows for THIS island. peers_service puts this string
    # straight into the directory entry the app's picker renders, so the DEFAULT is
    # what keeps a nameless island off the wire — a blank value is already deleted
    # before pydantic sees it (_normalise_env_strings + the absence-aware sources),
    # so blank falls back here with no resolver of its own.
    island_display_name: str = "Aiko"
